...
function Coins() {
    ...
    const toggleUiMode = (): void => {
        setIsUiModeFn((prev) => (prev === 'light' ? 'dark' : 'light'));
        console.log(`change Ui mode: ${isUiMode}`);
    };
    ...
    return (
        <Container>
            ...
            <ImgWrapper>
                <span>
                    <img src="https://static.coingecko.com/s/coingecko-branding-guide-8447de673439420efa0ab1e0e03a1f8b0137270fbc9c0b7c086ee284bd417fa1.png" alt="" />
                </span>
