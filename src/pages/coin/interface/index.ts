...
export type ID = 'bitcoin' | 'wrapped-bitcoin' | 'ethereum' | 'solana' | 'avalanche-2';
...
export type Base = 'BTC' | 'WBTC' | 'ETH' | 'SOL' | 'AVAX';
...
export type Target = 'USDT' | 'BTC' | 'USD' | 'EUR' | 'USDC' | 'JPY' | 'XTUSD' | 'XBT' | 'CAD';

export type TargetCoinID = 'tether' | 'bitcoin' | 'usd-coin' | 'xtusd';
